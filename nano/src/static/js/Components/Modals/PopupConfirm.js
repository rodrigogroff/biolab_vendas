        ...
        return `<div class="popup-overlay" id="popUpSystemConfirm_${mdlID}">
                <div class="popup-container" style='margin-top:50px;max-width:475px' align='center'>
                    <div class="popup-header">
                        <h3 style='padding-left:32px;color:black' class="popup-title" id='popUpSystemConfTitle'></h3>
                    ...
                    <div class="popup-content">
                        ...
                        <br><span id='popUpSystemConfText' style="padding-top:16px;color:black"></span><br><br>
                        <br>
